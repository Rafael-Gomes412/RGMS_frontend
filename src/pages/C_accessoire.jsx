...
function CAccessoire() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await api.get('/products/?category=accessoire')
  ...
  return (
    <div className="w-full min-h-screen">
      ...
      <div className="w-full px-8 py-10 border-b border-gray-100">
        ...
        <h1 className="text-3xl font-bold uppercase tracking-widest">Accessoires</h1>
